            ...
            <div class="col">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control @if ($errors->has('sigla')) is-invalid @endif"
                        name="sigla" placeholder="Sigla" value="{{ $dados->sigla }}" />
                    <label for="sigla">Sigla</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="number" class="form-control @if ($errors->has('tempo')) is-invalid @endif"
                        name="tempo" placeholder="Tempo do curso (anos)" value="{{ $dados->tempo }}" />

...
@section('conteudo')
    <form action="{{ route('disciplinas.store') }}" method="POST"> 
            ...
            <div class="col">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control @if ($errors->has('nome')) is-invalid @endif"
                        name="nome" placeholder="Nome" value="{{ old('nome') }}" /> <label for="nome">Nome da Disciplina</label>
        ...
        <div class="row">
            <div class="col">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control @if ($errors->has('curso')) is-invalid @endif"
                        name="curso_id" placeholder="Curso" list="curso_id" value="{{ old('curso') }}" />
        ...
        <div class="row">
            <div class="col">
                <div class="form-floating mb-3"> <input type="number"
                        ...
                        name="carga" placeholder="Carga horária (aulas por semana)" min="1" max="12"
                        value="{{ old('carga') }}" /> <label for="carga">Carga horária (aulas por semana)</label>
                    <div class='invalid-feedback'>
                        {{ $errors->first('carga') }}
                    </div>
                </div>

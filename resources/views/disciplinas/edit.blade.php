            ...
            <div class="col">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control @if ($errors->has('curso')) is-invalid @endif"
                        name="curso" placeholder="Curso" value="{{ $dados->curso->nome }}" />
                    <label for="curso">Curso</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="number" class="form-control @if ($errors->has('carga')) is-invalid @endif"
                        name="carga" placeholder="Carga horária (aulas por semana)" value="{{ $dados->carga }}" />
                    <label for="carga">Carga horária (aulas por semana)</label>
                </div>
            </div>
        </div>
        <div class="row">

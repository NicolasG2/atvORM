...
<form action="{{ route('alunos.update', $dados->id) }}" method="POST">
    ...
    <div class="row">
        <div class="col" >
            <div class="form-floating mb-3 @if($errors->has('nome')) is-invalid @endif">
                <input 
                    type="text" 
                    class="form-control" 
                    name="nome" 
    ...
    <div class="row">
        <div class="col">
            ...
            <a href="javascript:document.querySelector('form').submit();" class="btn-confirm btn btn-block align-content-center">
                Confirmar &nbsp;
